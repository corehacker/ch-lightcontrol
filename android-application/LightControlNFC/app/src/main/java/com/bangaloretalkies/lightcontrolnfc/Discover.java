...
/**
 * Created by Sandeep on 2/5/2015.
 */
...
public class Discover extends Thread {
    ...
    private static final int DISCOVERY_PORT = 10000;
    ...
    private void sendDiscoveryRequest(DatagramSocket socket) throws IOException {
        String data = String.format("device discover");
